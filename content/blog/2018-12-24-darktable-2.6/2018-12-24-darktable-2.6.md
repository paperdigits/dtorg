...
here:
[https://www.darktable.org/2018/12/darktable-260-released/](https://www.darktable.org/2018/12/darktable-260-released/).
...
base curve disabled:
  ...
  <div style="text-align: center">
  ![List of active modules]({filename}cb-active-modules.jpg)
  </div>
...
casts:
  ...
  <div style="text-align: center">
  ![Color picker patches]({filename}cb-patches-original.png)
  </div>
...
reduced:
  ...
  <div style="text-align: center">
  ![Neutralization picker in color balance]({filename}cb-picker-neutralize.jpg)
  </div>
...
that the 'b' value is now much closer to 0:
  ...
  <div style="text-align: center">
  ![Color picker patches after normalization]({filename}cb-patches-neutralized.png)
  </div>
...
luminance increased:
  ...
  <div style="text-align: center">
  ![Contrast management in color balance]({filename}cb-contrast.jpg)
  </div>
...
contest):
  ...
  <div style="text-align: center">
  ![Split toning with color balance]({filename}cb-split-toning.jpg)
  </div>
...
example (first image before, second image after application):
  ...
  <div style="text-align: center">
  ![Image before color balance]({filename}cb-before.jpg)
  </div>

  <div style="text-align: center">
  ![Image with orange and teal look]({filename}cb-orange-and-teal.jpg)
  </div>
...
* It is now possible to have scrollbars in lighttable and darkroom. They are disabled by default in darkroom, but can be activated if needed from the configuration (at the bottom of the "GUI options" tab):
  <div style="text-align: center">
![Configuration of scrollbars]({filename}scrollbars-config.png)
  </div>
  The scrollbars appear around the central part of the interface:
  <div style="text-align: center">
![Scrollbars in darkroom]({filename}darkroom-scrollbars.jpg)
  </div>
...
mouse instead of the left button to select the entry:
  ...
  <div style="text-align: center">
![Creating an instance for a preset]({filename}second-instance.png)
  </div>
...
The GUI will then have this aspect:
  ...
  <div style="text-align: center">
  ![White background CSS]({filename}white-background-css.jpg)
  </div>
